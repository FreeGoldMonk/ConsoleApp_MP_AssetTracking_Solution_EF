...
// update-database
// 
namespace ConsoleApp_MP_AssetTracking_Solution_EF
{
    class Program
    {
    ...
    class Context : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Data Source = (localdb)\MSSQLLocalDB; Initial Catalog = ConsoleApp_MP_AssetTracking_Solution_EF; Integrated Security = True; Connect Timeout = 30; Encrypt = False; TrustServerCertificate = False; ApplicationIntent = ReadWrite; MultiSubnetFailover = False");
        }
    }
}
